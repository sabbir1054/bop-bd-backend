/*
  ...
  - The values [REFFERED_MEMBER] on the enum `CommissionType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "CommissionType_new" AS ENUM ('NORMAL', 'REFERRED_MEMBER', 'SPECIAL_OFFER');
